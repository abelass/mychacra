<?php
	define(_INTERFACE_DOCUMENTS,'choix');
	/*
	 ...
	 */
	define ('_SITES_ADMIN_MUTUALISATION', 'mychacra.net');
	...
	define ('_INSTALL_NAME_DB',_INSTALL_SITE_PREF);

	define ('_INSTALL_SERVER_DB', 'mysql'); 
	define ('_INSTALL_HOST_DB', 'mysql.mychacra.net'); 
	define ('_INSTALL_USER_DB', 'abelass');  
	define ('_INSTALL_PASS_DB', 'malheur12'); 
	 ...
	 */
	define ('_INSTALL_HOST_DB_LOCALNAME', 'mysql.mychacra.net');
	...
	demarrer_site($site,
		array(
			...
			'code' => 'chuperlapup2012',        // Code d'activation ('ecureuil') 
